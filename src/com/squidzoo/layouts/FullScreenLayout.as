package com.squidzoo.layouts {
	...
	*/
	...
	public class FullScreenLayout extends LayoutBase {
		...
		private function positionCentralElement(element:ILayoutElement, width:Number, height:Number):Matrix3D {
			//element.setLayoutBoundsSize(FlexGlobals.topLevelApplication.stage.stageHeight,FlexGlobals.topLevelApplication.stage.stageWidth);
		...
		override public function updateDisplayList(width:Number, height:Number):void {
			...
			if (numElements > 0) {
				...
				dispatchEvent(new Event("Matrix"));
